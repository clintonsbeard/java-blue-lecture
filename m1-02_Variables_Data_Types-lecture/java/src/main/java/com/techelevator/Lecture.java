...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		String yourName = "Clinton Beardsley";
		...
		*/
		...
		int five = 5;
		int two = 2;
		double fiveTwo = (double) five / two;
		System.out.println(fiveTwo);
		
		double halfOfFivePointOh = 5.0 / 2.0;
		System.out.println(halfOfFivePointOh);
